...
public class GiveOutCommandTest {
    ...
    private GiveOutCommand giveOutCommand = new GiveOutCommand();
    ...
    public void shouldChangeStatusToArrived() throws IOException, ServletException {
        ...
        giveOutCommand.execute(request, response);

        Delivery founded = orderDAO.findDeliveryById(delivery.getId());

        assertEquals(DeliveryStatus.RECIEVED, founded.getLastStatus());
